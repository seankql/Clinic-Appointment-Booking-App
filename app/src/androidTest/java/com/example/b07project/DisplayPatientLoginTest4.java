...
public class DisplayPatientLoginTest4 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void displayPatientLoginTest4() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView8), withText("Patient: test2"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("Patient: test2")));
    }
